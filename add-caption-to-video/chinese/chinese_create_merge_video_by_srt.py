...
prefix_input_file_url   = 's3://'+bucket_name  + '/media-zh/input/'
prefix_srt_url          = 's3://'+bucket_name  + '/media-zh/srt/'
prefix_output_video_url = 's3://'+bucket_name  + '/media-zh/out_video/'
